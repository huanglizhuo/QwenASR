...
import 'package:qasr/qasr.dart';

/// Pure Dart API tests — no app, no UI.
///
/// Prerequisites:
///   cd flutter/qasr/rust && cargo build --release
///
/// Run:
///   cd flutter/qasr && flutter test test/qasr_api_test.dart
void main() {
  ...
  const dylibPath =
      '$projectRoot/flutter/qasr/rust/target/release/librust_lib_qasr.dylib';
