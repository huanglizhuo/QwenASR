...
///
/// Java class: com.qasr.QAsrEngine
///
/// ```java
...
#[no_mangle]
pub unsafe extern "C" fn Java_com_qasr_QAsrEngine_nativeLoadModel(
    env: JNIEnv,
    _obj: JObject,
    model_dir: JString,
    n_threads: JInt,
    ...
    let c_api_engine = crate::c_api::qasr_load_model(
...
#[no_mangle]
pub unsafe extern "C" fn Java_com_qasr_QAsrEngine_nativeTranscribePcm(
    env: JNIEnv,
    _obj: JObject,
    handle: JLong,
    samples: JFloatArray,
    ...
    let result = crate::c_api::qasr_transcribe_pcm(
        handle as *mut crate::c_api::QasrEngine,
        samples_ptr,
        n_samples,
    );
    ...
    crate::c_api::qasr_free_string(result);
    jstr
}

/// Transcribe WAV byte array.
#[no_mangle]
pub unsafe extern "C" fn Java_com_qasr_QAsrEngine_nativeTranscribeWav(
    env: JNIEnv,
    _obj: JObject,
    handle: JLong,
    wav_data: JByteArray,
    ...
    let result = crate::c_api::qasr_transcribe_wav_buffer(
        handle as *mut crate::c_api::QasrEngine,
...
/// Free engine.
#[no_mangle]
pub unsafe extern "C" fn Java_com_qasr_QAsrEngine_nativeFree(
    _env: JNIEnv,
    _obj: JObject,
    handle: JLong,
) {
    if handle != 0 {
        crate::c_api::qasr_free(handle as *mut crate::c_api::QasrEngine);
    }
}

/// Set segment seconds.
#[no_mangle]
pub unsafe extern "C" fn Java_com_qasr_QAsrEngine_nativeSetSegmentSec(
    _env: JNIEnv,
    _obj: JObject,
    handle: JLong,
    sec: JFloat,
    ...
    if handle != 0 {
        crate::c_api::qasr_set_segment_sec(handle as *mut crate::c_api::QasrEngine, sec);
    }
}
